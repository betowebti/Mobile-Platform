...
(function ($) {
	...
	loadYoumax = function() {	
		...
		if (youmax_global_options.youTubePlaylistURL == '')
		{
			$('#youmax').append('<div id="youmax-tabs"><span id="uploads_" class="youmax-tab">Uploads</span><span id="playlists_" class="youmax-tab">Playlists</span></div>');
		}
		else
		{
	...
	getChannelDetails = function(channelId) {
		...
		var apiProfileURL = youmax_global_options.url + "/api/v1/widget/get/youtube/getFeed?call=profile&channelId=" + channelId + "&sl=" + youmax_global_options.sl;
	...
	getVideoStats = function(videoIdList) {
		...
		apiVideoStatURL = youmax_global_options.url + "/api/v1/widget/get/youtube/getFeed?call=video-stat&videoIdList=" + videoIdList + "&sl=" + youmax_global_options.sl;
	...
	getUploads = function(youmaxTabId,playlistTitle,nextPageToken) {
		...
		var apiUploadURL = youmax_global_options.url + "/api/v1/widget/get/youtube/getFeed?call=upload&playlistId=" + uploadsPlaylistId + "&maxResults=" + youmax_global_options.maxResults + "&sl=" + youmax_global_options.sl;
	...
	getPlaylists = function(nextPageToken) {
		...
		var apiChannelPlaylistsURL = youmax_global_options.url + "/api/v1/widget/get/youtube/getFeed?call=ChannelPlaylists&channelId=" + youmaxChannelId + "&maxResults=" + youmax_global_options.maxResults + "&sl=" + youmax_global_options.sl;
		...
		*/
		...
		if(youTubeChannelURL!=null) {
			...
			if(s!=-1) {
				...
				apiUrl = youmax_global_options.url + "/api/v1/widget/get/youtube/getFeed?call=id&forUsername=" + userId + "&sl=" + youmax_global_options.sl;
	...
	$.fn.youmax = function(options) {
		...
		//set local options
		youmax_global_options.root = options.root;
		youmax_global_options.url = options.url;
		youmax_global_options.sl = options.sl;
