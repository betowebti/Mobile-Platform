...
/*
 |--------------------------------------------------------------------------
 | SoundCloud tracks, playlist and profiles
 |--------------------------------------------------------------------------
 */
...
<button type="button" class="btn btn-success btn-block btn-lg" onclick="addRepeaterRow('{{ $field_name }}')"><i class="fa fa-plus"></i> {{ trans('widget::global.add_soundcloud') }}</button>
