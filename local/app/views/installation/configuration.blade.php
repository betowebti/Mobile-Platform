...
@endif
               ...
               <div id="smtp_settings" style="display:<?php echo (\Input::old('email_driver', 'mail') == 'smtp') ? 'block': 'none'; ?>">
                ...
                <p class="panel-padding-h">For more information on configuration options, visit <a href="https://www2.nowsquare.com/mobile-platform/documentation/v2/configuration" target="_blank">https://www2.nowsquare.com/mobile-platform/documentation/v2/configuration</a>.</p>
